...
public class LocalServerRunner {
    ...
    public void startLocalServer() {
        ...
        try {
            String downloadURL = "https://repo1.maven.org/maven2/com/netflix/conductor/conductor-server/"
                    + conductorVersion + "/conductor-server-"
                    + conductorVersion + "-boot.jar";
    ...
    private synchronized void installAndStartServer(String repositoryURL, int localServerPort) throws IOException {
        ...
        String command = "java -Dserver.port=" + localServerPort
                + " -DCONDUCTOR_CONFIG_FILE=" + configFile + " -jar " + serverFile;
