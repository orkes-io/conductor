...
import static com.netflix.conductor.common.metadata.tasks.TaskType.TASK_TYPE_TRY;
...
/** {@link Try} task is a replacement for now deprecated {@link Decision} task. */
@Component(TASK_TYPE_TRY)
public class Try extends WorkflowSystemTask {
    ...
    public void cancel(WorkflowModel workflow, TaskModel task, WorkflowExecutor workflowExecutor) {
        super.cancel(workflow, task, workflowExecutor);
    }
}
